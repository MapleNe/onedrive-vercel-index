 ...
 * - If you are using a E5 Subscription 1OneDrive for Business account, the direct links of your files are not the same here.
 *   In which case you would need to change directLinkRegex.
 */
module.exports = {
  // The clientId and clientSecret are used to authenticate the user with Microsoft Graph API using OAuth. You would
  // not need to change anything here if you can authenticate with your personal Microsoft account with OneDrive International.
  clientId: 'a5a99dfa-fcdd-4211-bd6c-1f4d640b9d8c',
  obfuscatedClientSecret: 'U2FsdGVkX18D303Oh1LzK8UMQ4VXhcnHt5tsLC2HMo7gbZNa/5dtSXdwZVgeirwhYULCkiOGzt5SvuJgCY7Z+w==',
